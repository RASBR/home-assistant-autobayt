...
**URL:** https://api.autobayt.com/v1/user/get-things?user_id=67b1b9cbc53b2600rtgb1234
...
[
  ...
  },
  {
    ...
    "slave_id": "923748bc5xy1",
    "is_hub": false,
    "is_updating": false,
    "perc": 0,
    "period": 20000,
    "pat_period": 30,
    "device_id": "672859vb3kp8",
    "name": "Stairs-FF",
  ...
  },
  {
    "room_id": "67b1b9cbc53b260012fe10f7",
    "connection_status": true,
    "slave_id": "341876rt9sm3",
    "is_hub": false,
    "is_updating": false,
    "perc": 0,
    "period": 20000,
    "pat_period": 30,
    "device_id": "h7br659284j5",
    "name": "P EX",
    "firmware_version": "1.9.11",
    "model_name": "SW300LV1",
    "sstr": "-53",
...
```bash
curl --location 'api.autobayt.com/v1/device/trigger' \ --header 'Content-Type: application/json' \ --data '{ "btnStates": [true], "btnIds": [0], "device_id": "341876rt9sm3"
```
...
```json
{
  "device": {
    ...
    "user_id": "67b1b9cbc53b2600rtgb1234",
    "added_by": "67b1b9cbc53b2600rtgb1235",
